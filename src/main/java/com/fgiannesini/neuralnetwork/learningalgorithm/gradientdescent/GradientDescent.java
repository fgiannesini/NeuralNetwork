...
public class GradientDescent implements LearningAlgorithm, InternalGradientDescent {
    ...
    public NeuralNetworkModel learn(DoubleMatrix inputMatrix, DoubleMatrix y) {
        GradientLayerProvider provider = getForwardComputationLauncher().apply(new ForwardComputationContainer(inputMatrix, correctedNeuralNetworkModel));
        List<GradientDescentCorrection> gradientDescentCorrections = getBackwardComputationLauncher().apply(new BackwardComputationContainer(provider, y, getFirstErrorComputationLauncher(), getErrorComputationLauncher()));
    ...
    protected NeuralNetworkModel applyGradientDescentCorrections(List<GradientDescentCorrection> gradientDescentCorrections, int inputCount) {
        ...
        Function<GradientDescentCorrectionsContainer, NeuralNetworkModel> gradientDescentCorrectionsLauncher = getGradientDescentCorrectionsLauncher();
