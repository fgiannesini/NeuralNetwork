...
class BatchNormLayerComputerTest {
    ...
    void compute_on_weight_matrix_and_batch_norm() {
        ...
        DoubleMatrix output = new BatchNormLayerComputer().computeAFromInput(DoubleMatrix.ones(5).mul(3f), layer);
    ...
    void compute_on_weight_matrix_and_batch_norm_with_three_inputs() {
        ...
        DoubleMatrix output = new BatchNormLayerComputer().computeAFromInput(DataFormatConverter.fromDoubleTabToDoubleMatrix(input), layer);
